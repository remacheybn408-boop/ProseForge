...
from src.utils.consequence_lexicon import (
    find_all_consequences,
    count_visible_consequences,
    has_minimum_visible_cost,
)
from src.utils.sensory_lexicon import SCENE_ANCHOR_PATTERN
...
# 场景锚点：光、温度、声音、气味、干湿（已迁移至 src.utils.sensory_lexicon.SCENE_ANCHOR_PATTERN）
SCENE_ANCHOR_PATTERNS = SCENE_ANCHOR_PATTERN
