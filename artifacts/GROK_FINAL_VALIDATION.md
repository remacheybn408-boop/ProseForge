...
Validation source commit: `790360c`
...
| Web typecheck/unit/build | `docker compose ... run --rm web-test` | 0 | 15 files, 42 tests passed; typecheck/build passed |
| Authenticated E2E | `docker compose ... run --rm e2e` | 0 | 11 passed |
