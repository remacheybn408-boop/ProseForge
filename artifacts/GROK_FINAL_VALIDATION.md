...
Validation source commit: `e556924`
...
| Web typecheck/unit/build | `docker compose ... run --rm web-test` | 0 | 14 files, 31 tests passed; typecheck/build passed |
