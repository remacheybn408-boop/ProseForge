...
[![Test](https://github.com/remacheybn408-boop/ProseForge/actions/workflows/test.yml/badge.svg)](https://github.com/remacheybn408-boop/ProseForge/actions/workflows/test.yml)
...
- [已迁移] nf_新建 — 创建新小说项目（Hermes 工具）
- [已迁移] nf_导出 — 导出完整小说（Hermes 工具）
- [待定] 数据库备份（暂无直接工具）
- Backlog：Hermes 技能 / 更多原生工具
