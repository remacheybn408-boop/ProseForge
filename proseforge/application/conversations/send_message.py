...
class SendMessage:
    ...
    async def execute(self, *, branch_id: str, content: str, client_request_id: str):
        async with self.uow_factory() as uow:
            ...
            await uow.commit()
        task_id = await self.queue.enqueue("proseforge.chat.generate", {"message_id": assistant.id, "user_message_id": user.id})
